...
export function generateEmailTemplate(
  ...
  const chartData = results.answers.map(
    (
      answer: {
        isCorrect: boolean;
        question: string;
  ...
  // The return type is string, as per the function signature.
  return `
    <!DOCTYPE html>
    <html lang="hu">
    <head>
            ...
            <style>
                    * {
                    ...
                    .question-result {
                            ...
                            padding: 15px;
                            background-color: ${
                              isLight ? "#f8f9fa" : "#3a3a3a"
                            };
                            border-radius: 6px;
                            border-left: 4px solid ${
                              isLight ? "#28a745" : "#4CAF50"
                            };
                    }
                    .question-result.incorrect {
                            border-left-color: ${
                              isLight ? "#dc3545" : "#f44336"
                            };
                    }
                    .question-text {
                            font-weight: bold;
